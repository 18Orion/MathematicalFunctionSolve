#############################################################################
# Makefile for building: Functions
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  Functions.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Functions.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Functions1.0.0
DISTDIR = /Datos/Programación/Proyectos\ C++/Introducción\ de\ funciones/.tmp/Functions1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -fPIC
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		Functions.pro include/funcion.hpp main.cpp \
		src/funcion.cpp
QMAKE_TARGET  = Functions
DESTDIR       = 
TARGET        = Functions
...
Makefile: Functions.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		Functions.pro
	$(QMAKE) -o Makefile Functions.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/funcion.hpp $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp src/funcion.cpp $(DISTDIR)/
...
main.o: main.cpp include/funcion.hpp
